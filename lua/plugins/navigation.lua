	  ...
	  config = function()
		require("trouble").setup {
		  ...
		  -- refer to the configuration section below
			...
			vim.keymap.set("n", "<leader>xn", '<cmd>lua require("trouble").next({skip_groups = true, jump = true})<cr>',
			  {silent = true, noremap = true}
			);
			vim.keymap.set("n", "<leader>xp", '<cmd>lua require("trouble").previous({skip_groups = true, jump = true})<cr>',
			  {silent = true, noremap = true}
			);
		}
	  end
