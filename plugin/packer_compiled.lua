...
_G.packer_plugins = {
  ...
  ["cosco.vim"] = {
    config = { "\27LJ\2\nÑ\2\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0‰\1\t\t\t\taugroup semicolon_files\n\t\t\t\tautocmd!\n\t\t\t\tautocmd FileType rust nmap <silent> <Leader>; <Plug>(cosco-commaOrSemiColon)\n\t\t\t\tautocmd FileType rust imap <silent> <c-;> <c-o><Plug>(cosco-commaOrSemiColon)\n\t\t\t\taugroup end\n\t\t\t\bcmd\bvim\0" },
    loaded = true,
    path = "/home/jerryminion/.local/share/nvim/site/pack/packer/start/cosco.vim",
...
time([[Config for cosco.vim]], true)
try_loadstring("\27LJ\2\nÑ\2\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0‰\1\t\t\t\taugroup semicolon_files\n\t\t\t\tautocmd!\n\t\t\t\tautocmd FileType rust nmap <silent> <Leader>; <Plug>(cosco-commaOrSemiColon)\n\t\t\t\tautocmd FileType rust imap <silent> <c-;> <c-o><Plug>(cosco-commaOrSemiColon)\n\t\t\t\taugroup end\n\t\t\t\bcmd\bvim\0", "config", "cosco.vim")
time([[Config for cosco.vim]], false)
